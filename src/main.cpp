...
int main(int argc, char** argv) {
  ...
  while (1) {
    ...
    log_snapshot.lka_ey_m = lka_reference_snapshot.ey_m;
    log_snapshot.lka_epsi_rad = lka_reference_snapshot.epsi_rad;
    log_snapshot.lka_mean_kappa_m_inv = lka_reference_snapshot.mean_kappa_m_inv;
    log_snapshot.lka_std_kappa_m_inv = lka_reference_snapshot.std_kappa_m_inv;
