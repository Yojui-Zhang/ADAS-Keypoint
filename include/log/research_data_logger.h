...
struct ResearchLogFrame {
  ...
  double stability_curve_speed_limit_kmh = 0.0;
  bool stability_curve_is_bottleneck = false;
  double stability_a_long_need_mps2 = 0.0;
  double stability_a_long_cmd_mps2 = 0.0;
  ...
  double acc_target_raw_relative_speed_mps = 0.0;
  double acc_target_control_relative_speed_mps = 0.0;
  bool acc_long_range_closing_guard_active = false;
  bool acc_closing_evidence_confirmed = false;
  bool acc_closing_measurement_credible = false;
  double acc_closing_evidence_confirm_time_s = 0.0;
  ...
  bool acc_opening_recovery_active = false;
  double acc_opening_recovery_target_speed_kmh = 0.0;
  double acc_opening_recovery_confirm_time_s = 0.0;
  ...
  bool aeb_audio_play_accepted = false;
  std::string aeb_audio_trigger_reason = "none";
  int aeb_audio_threat_id = -1;
  double aeb_audio_ttc_s = 0.0;
  double aeb_audio_forward_m = 0.0;
  double aeb_audio_approach_speed_mps = 0.0;
  double aeb_audio_longitudinal_closing_mps = 0.0;
  double aeb_audio_current_path_distance_m = 0.0;
  bool aeb_audio_same_threat_armed = true;
